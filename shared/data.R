...
#shp.curr_county <-("/gpfs/data1/cmongp/lansong/cec_lan/shapefiles/Napa.shp")
#county_name <-"Napa"
#load_county_shapefile(shp.curr_county, county_name)
load_county_shapefile = function(shp.curr_county, county_name){
   
  shapes_dir = "/gpfs/data1/cmongp/lansong/cec_lan/shapefiles/"
